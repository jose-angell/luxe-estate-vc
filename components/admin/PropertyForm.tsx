          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label
                    className="block text-xs font-medium text-gray-500 mb-1.5 font-sf"
                    htmlFor="latitude"
                  >
                    <span className="flex items-center gap-1">
                      <span className="material-icons text-[14px] text-[var(--color-mosque)]">my_location</span>
                      Latitude
                    </span>
                  </label>
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-md border border-gray-200 bg-white text-[var(--color-nordic-dark)] placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[var(--color-mosque)] focus:border-[var(--color-mosque)] transition-all text-sm font-sf"
                  />
                </div>
                <div>
                  <label
                  ...
                  >
                    <span className="flex items-center gap-1">
                      <span className="material-icons text-[14px] text-[var(--color-mosque)]">explore</span>
                      Longitude
                    </span>
                  </label>
                  <input
