          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="flex gap-4 overflow-x-auto hide-scroll pb-2 snap-x">
              {property.images.map((img, idx) => (
                <div key={idx} className={`flex-none w-48 aspect-[4/3] rounded-lg overflow-hidden cursor-pointer snap-start relative ${idx === 0 ? "ring-2 ring-mosque ring-offset-2 ring-offset-background-light" : "opacity-70 hover:opacity-100 transition-opacity"}`}>
                  <Image 
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-nordic-dark/5">
                <div className="mb-4">
                  <h1 className="text-4xl font-display font-light text-nordic-dark mb-2">
                    {formattedPrice}{property.pricePerMonth && <span className="text-xl">/mo</span>}
                  </h1>
              ...
              <div className="bg-mosque/5 p-6 rounded-xl border border-mosque/10 flex flex-col sm:flex-row items-center justify-between gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-nordic-dark/60">Starting from <strong className="text-mosque">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(property.price * 0.005)}/mo</strong> with 20% down</p>
                  </div>
                </div>
