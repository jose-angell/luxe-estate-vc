    ...
    <div className="font-display bg-background-light min-h-screen flex items-center justify-center p-4 antialiased text-nordic-dark relative overflow-hidden">
      ...
      <main className="w-full max-w-md z-10">
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 backdrop-blur-sm">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="group w-full flex items-center justify-center gap-3 bg-white border border-gray-100 rounded-lg p-3.5 text-nordic-dark font-medium transition-all duration-300 hover:shadow-[0_10px_25px_-5px_rgba(25,50,47,0.1)] hover:-translate-y-0.5 relative overflow-hidden disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none"
            >
              {/* Hover overlay */}
              <div className="absolute inset-0 bg-hint-green/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out pointer-events-none" />

              {loadingProvider === "google" ? (
                <svg
                  className="w-5 h-5 relative z-10 animate-spin text-nordic-muted"
                  viewBox="0 0 24 24"
                  fill="none"
                >
                  <circle
            ...
            >
              ...
              {loadingProvider === "github" ? (
                ...
                <svg
                  className="w-5 h-5 relative z-10 fill-current text-nordic-dark"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <p className="mt-8 text-center text-sm text-nordic-muted">
            ...
            <span className="font-semibold text-mosque">
              Sign up via Google or GitHub above
            </span>
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <nav className="flex justify-center gap-6 text-xs text-nordic-muted/70">
            <a
              href="#"
              className="hover:text-nordic-dark transition-colors"
            >
              Privacy Policy
            </a>
            <a
